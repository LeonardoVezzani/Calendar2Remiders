...
2) create a new script and paste the code in the repo
You can then run the script by clicking on it in the Scriptable app
...
4) select "run script" (usualy second option that pops up) and select Calendar2Reminders (insert no parameters)
